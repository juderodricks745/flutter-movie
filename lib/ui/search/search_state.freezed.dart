...
class _$SearchStateTearOff {
  ...
  _Results data(List<ResultsModel>? results) {
    return _Results(
      results,
    );
  }
...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ResultsModel>? results) data,
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<ResultsModel>? results)? data,
...
class _$_Results implements _Results {
  ...
  @override
  String toString() {
    return 'SearchState.data(results: $results)';
  }
...
abstract class _Results implements SearchState {
  const factory _Results(List<ResultsModel>? results) = _$_Results;
